...
const ApproverAccountsPage = () => {
  ...
  const filteredApprovers = approvers.filter((approver) =>
    approver.username.toLowerCase().includes(searchQuery.toLowerCase())
  );
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex mb-4">
                <div className="mr-4">
                  ...
                  <input type="text" className="border-2 rounded-md py-2" id="middleName" {...register("middleName", {required: true,})} defaultValue={editApprover?.middleName} />
                </div>
                <div className="px-8">
                  <label htmlFor="password" className="py-2 block mb-1 text-primary font-bold">Password</label>
                  <input type="password" className="border-2 rounded-md py-2" id="password" {...register("password", {required: true,})} defaultValue={editApprover?.password} />
                </div>
              </div>
